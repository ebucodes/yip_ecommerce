...
<footer class="footer padding-t-100 bg-off-white">
    <div class="container">
        <div class="row footer-top padding-b-100">
            <div class="col-xl-4 col-lg-6 col-sm-12 col-12 cr-footer-border">
                <div class="cr-footer-logo">
                    ...
                    <p>{$appName} is the biggest market of grocery products. Get your daily needs from our
                        store.</p>
                </div>
                <div class="cr-footer">
            ...
            <div class="col-xl-4 col-lg-6 col-sm-12 col-12 cr-footer-border">
                <div class="cr-footer">
                    ...
                    <ul class="cr-footer-links cr-footer-dropdown">
                        <li><a href="{$aboutUsRoute}">About Us</a></li>
                        {* <li><a href="track-order.html">Delivery Information</a></li> *}
                        <li><a href="{$policyRoute}">Privacy Policy</a></li>
                        {* <li><a href="terms.html">Terms & Conditions</a></li> *}
                        <li><a href="{$contactUsRoute}">contact Us</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-sm-12 col-12 cr-footer-border">
        ...
        <div class="cr-last-footer">
            <p>&copy; <span id="copyright_year"></span> <a href="{$homePageRoute}">{$appName}</a>,
                All rights
                reserved.</p>
        </div>
    </div>
